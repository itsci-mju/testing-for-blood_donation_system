...
String xlPath_tc = "D:/Project/Result/TC16 Add Blood Donate Activity/TC16 Add Blood Donate ActivityResult.xlsx";
String xlPath_ts = "D:/Project/Result/TC16 Add Blood Donate Activity/TS16 Add Blood Donate ActivityResult.xlsx";
String xlPath_td = "D:/Project/Result/TC16 Add Blood Donate Activity/TD16 Add Blood Donate ActivityResult.xlsx";
String xlPath ="D:/Project/KDF/TC16 Add Blood Donate Activity.xlsx";
	...
	if(xTCdata[i][4].equalsIgnoreCase('Y')){
		...
		String actual_text = "";
			...
			if(xTDdata[j][1].equalsIgnoreCase('Y')){
				...
				CustomKeywords.'webTest.NewKeywords.edit_inputs'(xTSdata[7][5], xTDdata[j][7])
				CustomKeywords.'webTest.NewKeywords.edit_inputs'(xTSdata[8][5], xTDdata[j][8])
				CustomKeywords.'webTest.NewKeywords.edit_inputs'(xTSdata[9][5], xTDdata[j][9])
				CustomKeywords.'webTest.NewKeywords.edit_inputs'(xTSdata[10][5], xTDdata[j][10])
				CustomKeywords.'webTest.NewKeywords.button_click'(xTSdata[11][5])
				try {
					...
					xTDdata[j][12] = actual_text
					if(actual_text.equals(xTDdata[j][11])){
						xTDdata[j][13] = "Pass"
					}else{
						   xTDdata[j][13] = "Fail"
						   xTDdata[j][14] = "- Not Match Expected Result -"
						   xTDdata[j][15] = "TC16_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("D:/Project/Result/Capture/TC16_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
