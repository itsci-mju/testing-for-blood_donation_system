	...
	if(xTCdata[i][4].equalsIgnoreCase('y')){
		...
		for(int j = 1; j < xTDdata.length; j++){
			...
			if(xTDdata[j][1].equalsIgnoreCase('y')){
				...
				WebUI.setText(findTestObject('Object Repository/Page_Login Page/input__username'), 'officer1')
				...
				WebUI.click(findTestObject('Object Repository/Page_Login Page/a_'))
				...
				CustomKeywords.'webTest.NewKeywords.button_click'(xTSdata[10][5])
