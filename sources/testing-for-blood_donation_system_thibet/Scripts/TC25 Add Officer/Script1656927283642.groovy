...
String xlPath_tc = "D:/Project/Result/TC25 Add Officer/TC25 Add OfficerResult.xlsx";
String xlPath_ts = "D:/Project/Result/TC25 Add Officer/TS25 Add OfficerResult.xlsx";
String xlPath_td = "D:/Project/Result/TC25 Add Officer/TD25 Add OfficerResult.xlsx";
String xlPath ="D:/Project/KDF/TC25 Add Officer.xlsx";
		...
		String actual_text = "";
			...
			if(xTDdata[j][1].equalsIgnoreCase('Y')){
				...
				try {
					...
					xTDdata[j][11] = actual_text
					if(actual_text.equals(xTDdata[j][10])){
						xTDdata[j][12] = "Pass"
					}else{
						   xTDdata[j][12] = "Fail"
						   xTDdata[j][13] = "- Not Match Expected Result -"
						   xTDdata[j][14] = "TC25_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("D:/Project/Result/Capture/TC25_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()	
			}	
