...
//		String text2 = driver.findElementById(id2).getText();
	...
	public void input_firstname(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}
	
	public void input_lastname(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}
	
	public void input_birthday(String id, String id2, String xpath, String id3, String id4, String fText) throws ParseException {
	...
	public void input_address(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}
	
	public void input_tel(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}
	
	public void input_career(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}
	
	public void input_email(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}
	...
	public void input_conFpassword(String id, String fText) {
		driver.findElement(By.id(id)).clear();
		driver.findElement(By.id(id)).sendKeys(fText);
		}

	public void type_gender(String xpath, String fText) {
		...
		List <MobileElement> type_gender = driver.findElements(By.xpath(xpath));
			...
			for(MobileElement ts : type_gender) {
				...
				if(fText.equals(ts.getText())) {
					ts.click();
					break;
					}else if(fText.equalsIgnoreCase("men")) {
						type_gender.get(0).click();
						break;
					}else if(fText.equalsIgnoreCase("female")) {
						type_gender.get(1).click();
						break;
					}else {
						System.out.println("type_gender is not matt!!");
					}
			}
		} 
