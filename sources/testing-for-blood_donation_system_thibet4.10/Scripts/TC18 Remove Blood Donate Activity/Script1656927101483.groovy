...
String xlPath_tc = "D:/Project/Result/TC18 Remove Blood Donate Activity/TC18 Remove Blood Donate ActivityResult.xlsx";
String xlPath_ts = "D:/Project/Result/TC18 Remove Blood Donate Activity/TS18 Remove Blood Donate ActivityResult.xlsx";
String xlPath_td = "D:/Project/Result/TC18 Remove Blood Donate Activity/TD18 Remove Blood Donate ActivityResult.xlsx";
String xlPath ="D:/Project/KDF/TC18 Remove Blood Donate Activity.xlsx";
	...
	if(xTCdata[i][4].equalsIgnoreCase('Y')){
		...
		String actual_text = "";
			...
			if(xTDdata[j][1].equalsIgnoreCase('Y')){
				...
				CustomKeywords.'webTest.NewKeywords.rem_click'(xTDdata[j][4])
				...
				try {
					...
					actual_text = CustomKeywords.'webTest.NewKeywords.getalert_text'();
					...
					if(actual_text.equals(xTDdata[j][5])){
						xTDdata[j][7] = "Pass"
						   ...
						   xTDdata[j][9] = "TC18_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("D:/Project/Result/Capture/TC18_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
