...
String xlPath_tc = "D:/Project/Result/TC22 Remove Reward/TC22 Remove RewardResult.xlsx";
String xlPath_ts = "D:/Project/Result/TC22 Remove Reward/TS22 Remove RewardyResult.xlsx";
String xlPath_td = "D:/Project/Result/TC22 Remove Reward/TD22 Remove RewardResult.xlsx";
String xlPath ="D:/Project/KDF/TC22 Remove Reward.xlsx";
	...
	if(xTCdata[i][4].equalsIgnoreCase('Y')){
		...
		String actual_text = "";
			...
			if(xTDdata[j][1].equalsIgnoreCase('Y')){
				...
				CustomKeywords.'webTest.NewKeywords.app_click'(xTDdata[j][4])
				...
				try {
					...
					if(actual_text.equals(xTDdata[j][5])){
						xTDdata[j][7] = "Pass"
						   ...
						   xTDdata[j][9] = "TC22_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("D:/Project/Result/Capture/TC22_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
