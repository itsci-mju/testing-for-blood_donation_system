...
String xlPath_tc = "D:/Project/Result/TC21 Edit Reward/TC21 Edit RewardResult.xlsx";
String xlPath_ts = "D:/Project/Result/TC21 Edit Reward/TS21 Edit RewardResult.xlsx";
String xlPath_td = "D:/Project/Result/TC21 Edit Reward/TD21 Edit RewardResult.xlsx";
String xlPath ="D:/Project/KDF/TC21 Edit Reward.xlsx";
	...
	if(xTCdata[i][4].equalsIgnoreCase('Y')){
		...
		String actual_text = "";
			...
			if(xTDdata[j][1].equalsIgnoreCase('Y')){
				...
				CustomKeywords.'webTest.NewKeywords.PictureList'(xTSdata[10][5], xTDdata[j][7])
				CustomKeywords.'webTest.NewKeywords.listhealth_select'(xTSdata[11][5], xTDdata[j][8])
				...
				try {
					...
					if(actual_text.equals(xTDdata[j][9])){
						xTDdata[j][11] = "Pass"
						   ...
						   xTDdata[j][13] = "TC21_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("D:/Project/Result/Capture/TC21_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
